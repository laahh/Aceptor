<aside
        ...
        <ul class="flex flex-col pl-0 mb-0">
                ...
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    ...
                    <div id="dropdown"
                        ...
                        <ul class=" text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                            <li>
                                <a href="page"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pengertian</a>
                            </li>
                            <li>
                                <a href="page1"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Penyebab</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Gejala</a>
                            </li>
                            <li>
                                <a href="#"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pengobatan</a>
                            </li>
                        </ul>
                    </div>
            ...
            {{-- <li class="mt-0.5 w-full">
                <a @if (Request::path()=='page' )
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Apa Itu TBC</span>
                </a>
            </li> --}}
    ...
    {{-- <div class="mx-4">
        ...
        <p class="invisible hidden text-gray-800   "></p>
