...
<div>
    <h1 class="mx-10">Edit Artikel</h1>
</div>

<div class="mx-10 mt-10">

    <form method="POST" action="/admin-artikel/{{ $post->id }}" enctype="multipart/form-data">
        @method('put')
        @csrf
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <input type="text" id="tittel"
                    ...
                    required autofocus name="tittel" value="{{ $post->tittel }}">
            ...
            <div>
                ...
                <input type="text" id="slug"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required name="slug" value="{{ $post->slug }}">
            </div>
            <div>
                <label for="excerpt"
                ...
                <input type="text" id="excerpt"
                    class="bg-gray-50 border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required name="excerpt" value="{{ $post->excerpt }}">
            </div>
            ...
            <div class="mb-5">
                ...
                @if($post->image)
                <img src="{{asset('storage/'.$post->image)}}" class="w-80 rounded-md img-preview" alt="image">
                @else
        ...
        <div>
            ...
            <input id="body" type="hidden" name="body" required value="{!!html_entity_decode($post->body)!!}">
        ...
        <button type="submit" onclick="return confirm('Are you sure you want to update this item?');"
